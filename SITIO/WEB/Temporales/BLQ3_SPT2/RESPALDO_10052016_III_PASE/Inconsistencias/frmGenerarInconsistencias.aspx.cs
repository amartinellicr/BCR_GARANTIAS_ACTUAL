    ...
    public partial class Inconsistencias_frmGenerarInconsistencias : BCR.Web.SystemFramework.PaginaPersistente
    {
            ...
            if (_objContext != null)
            {
                try
                {
                    ...
                    if (ValidarDatos())
                    {
                        ...
                        //Genera el archivo de inconsistencias referentes a las pólizas de garantías reales
                        if (chkPolizasGarantiasReales.Checked)
                        {
                            EliminarArchivos("Errores en Pólizas");
                            Gestor.GenerarErrorPolizasGarantiaRealTXT(strRuta, Global.UsuarioSistema, false);
                            ComprimirArchivo(strRuta, "Errores en Pólizas.txt", strRuta + "Errores en Pólizas.zip");
                        }


                        //Genera el archivo de inconsistencias referentes al porcentaje de aceptacion calculado
                        if (chkErrorPorcentajeAceptacion.Checked)
                        {
                            EliminarArchivos("Errores en Porcentaje de Aceptación");
                            Gestor.GenerarErrorPorcentajeAceptacionRealTXT(strRuta, Global.UsuarioSistema, false);
                            ComprimirArchivo(strRuta, "Errores en Porcentaje de Aceptación.txt", strRuta + "Errores en Porcentaje de Aceptación.zip");
                        }
        ...
        private bool ValidarDatos()
        {
            ...
            if (!chkErrorInscripcion.Checked && !chkErrorPartidoFinca.Checked && !chkErrorTipoGarantiaReal.Checked
                && !chkErrorValuaciones.Checked && !chkClasesGarantiaReal.Checked && !chkPolizasGarantiasReales.Checked && !chkErrorPorcentajeAceptacion.Checked)
            {
