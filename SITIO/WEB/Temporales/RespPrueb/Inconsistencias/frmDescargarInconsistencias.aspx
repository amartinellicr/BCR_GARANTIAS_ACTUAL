<%@ Page Language="C#" MasterPageFile="~/Pagina Maestra/mtpMenuPrincipal.master" AutoEventWireup="true" CodeFile="frmDescargarInconsistencias.aspx.cs" Inherits="BCRGARANTIAS.Forms.Inconsistencias_frmDescargarInconsistencias" Title="BCR GARANTIAS - Archivos Inconsistencias" %>
		...
		<table style="WIDTH: 775px" cellPadding="1" width="775" align="center" bgColor="window"
			...
			<tr>
				<td style="HEIGHT: 43px" align="center" colSpan="3">
				    <asp:label id="lblTexto" runat="server" CssClass="TextoTitulo"> Descarga de Archivos de Inconsistencias</asp:label>
				</td>
			</tr>
			<tr>
