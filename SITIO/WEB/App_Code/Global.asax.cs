...
public class Global : System.Web.HttpApplication 
{
    ...
    void Application_Start(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //AOS USADOS PARA EL CALCULO DE LA FECHA DE PRESCRIPCION DE GARANTIAS REALES
        ...
        catch (Exception ex)
        {
            ...
            Response.Redirect(strRutaActual + "/frmMensaje.aspx?" +
                                        "bError=1" +
                                        "&strTitulo=" + "Problemas Cargando Pgina" +
                                        "&strMensaje=Inicializando la aplicacin" +
