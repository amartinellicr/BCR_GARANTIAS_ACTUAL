    ...
    public void cargaConsulta()
    {
        ...
        if ((txtFechaInicial.Text != string.Empty) && (txtFechaFinal.Text != string.Empty))
        {
            ...
            if (ValidarFechas(dFechaInicial, dFechaFinal))
            {
                ...
                oParametros.Add("strCriterioOrden", (((cbCriterioOrden != null) && (cbCriterioOrden.Items.Count > 0) && (cbCriterioOrden.SelectedItem.Value.Length > 0)) ? cbCriterioOrden.SelectedItem.Value : "cod_usuario"));
