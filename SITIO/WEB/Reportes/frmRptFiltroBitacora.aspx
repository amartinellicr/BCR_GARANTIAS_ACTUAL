 									                ...
 									                <tr>
									                    ...
									                    <td class="td_TextoIzq">
                                                            ...
                                                            <asp:DropDownList id="cbCriterioOrden" style="Z-INDEX: 50; POSITION: relative; vertical-align:middle"
		                                                        ...
		                                                        <asp:ListItem Value="cod_usuario" Text="C&#243;digo Usuario" Selected="True"></asp:ListItem>
	                                                ...
	                                                <tr>
	                                                    ...
	                                                    <td class="td_TextoIzq">
                                                            ...
                                                            <asp:DropDownList ID="cbMantenimientos" runat="server">
		                                                        ...
		                                                        <asp:ListItem Value="7">Deudores/Codeudores</asp:ListItem>
		                                                        ...
		                                                        <asp:ListItem Value="8">Histórico de Ingresos</asp:ListItem>
		                                                        <asp:ListItem Value="9">Mantenimiento de Valuaciones Reales</asp:ListItem>
		                                                        <asp:ListItem Value="10">Peritos</asp:ListItem>
		                                                        <asp:ListItem Value="11">Empresas</asp:ListItem>
		                                                        <asp:ListItem Value="12">Catálogos</asp:ListItem>
		                                                        <asp:ListItem Value="13">Perfiles</asp:ListItem>
		                                                        <asp:ListItem Value="14">Roles por Perfil</asp:ListItem>
		                                                        <asp:ListItem Value="15">Usuarios</asp:ListItem>
                                                            </asp:DropDownList> 
	                                                    </td>
	                                                </tr>
		                                        </table>
