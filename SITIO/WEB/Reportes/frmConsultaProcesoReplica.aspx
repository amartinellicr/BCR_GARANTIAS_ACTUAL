<%@ Page Language="C#" MasterPageFile="~/Pagina Maestra/mtpMenuPrincipal.master" AutoEventWireup="true" CodeFile="frmConsultaProcesoReplica.aspx.cs" Inherits="Reportes_frmConsultaProcesoReplica" Title="Ejecución de Procesos de Réplica" %>
							    ...
							    <td align="center">
								            <asp:GridView ID="gdvReporte" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="730px" AllowPaging="True" AllowSorting="True"
                                             ...
                                             DataKeyNames="cocProceso, fecIngreso, Resultado, desObservacion" > 
                                                ...
                                                <Columns>
                                                    <asp:ButtonField DataTextField="fecIngreso" HeaderText="Fecha-Hora Ejecución" Visible="True" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderColor="black" HeaderStyle-BorderColor="black"/>
