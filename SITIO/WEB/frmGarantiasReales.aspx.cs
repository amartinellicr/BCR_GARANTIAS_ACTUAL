...
namespace BCRGARANTIAS.Forms
{
    public partial class frmGarantiasReales : BCR.Web.SystemFramework.PaginaPersistente
    {
        ...
        private bool bEsCambioTipoGarantia = false;
        ...
        private void btnModificar_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (entidadValida)
                {
                    if ((!MostrarErrorMontoMitigador) || (!MostrarListaOperaciones))
                    {
        ...
        private void btnEliminar_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                strOperacionCrediticia = txtContabilidad.Text + txtOficina.Text + txtMoneda.Text;
        ...
        protected void cbTipoBien_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                string numeroGarantia = ((gdvGarantiasReales.SelectedDataKey[6] != null) ? gdvGarantiasReales.SelectedDataKey[6].ToString() : "Sin Definir");
            ...
            try
            {
                switch (e.CommandName)
                {
                    case ("SelectedGarantiaReal"):
                        ...
                        DescripcionGarantia = gdvGarantiasReales.SelectedDataKey[6].ToString();

                        tipoGarantiaReal = int.Parse(gdvGarantiasReales.SelectedDataKey[4].ToString());
        ...
        private void GuardarDatosSession()
        {
            ...
            catch (Exception ex)
            {
                ...
                lblMensaje.Text = Mensajes.Obtener(Mensajes.ERROR_GUARDANDO_SESION, Mensajes.ASSEMBLY);
            }
        }
        ...
        private void CargarDatosGarantia(long nOperacion, long nGarantia, string desGarantia, out bool bloquearControles, bool obtenerDatosBD, int tipoGarantiaReal)
        {
            ...
            if ((entidadGarantia != null) && (!entidadGarantia.ErrorDatos))
            {
                ...
                txtPorcentajeAceptacion.Text = entidadGarantia.PorcentajeResponsabilidad.ToString("N");
            ...
            if (requestSM != null && requestSM.IsInAsyncPostBack)
            {
                ScriptManager.RegisterClientScriptBlock(this,
                                                        typeof(Page),
                                                        Guid.NewGuid().ToString(),
                                                        "<script type=\"text/javascript\" language=\"javascript\">document.body.style.cursor = 'default'; $(document).ready(function(){ AsignarListaSemestres('" + entidadGarantia.ListaSemestresCalcular.ObtenerJSON() + "'); });</script>",
                                                        false);
            }
            else
            {
        ...
        private void ModificarGarantia()
        {
            ...
            {
                Gestor.NormalizarValuaciones(entidadGarantia, Session["strUSER"].ToString(), Request.UserHostAddress.ToString(), strOperacionCrediticia, strGarantia);
            }
