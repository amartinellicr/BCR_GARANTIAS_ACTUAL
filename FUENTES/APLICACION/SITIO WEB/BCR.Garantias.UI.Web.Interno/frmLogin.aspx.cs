...
namespace BCRGARANTIAS
{
    public partial class frmLogin : BCR.Web.SystemFramework.PaginaPersistente
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    txtClave.Attributes.Add("autocomplete", "off");
                    ...
                    {
                        //Asigna a la caja de texto el nombre del usuario logueado en dicha mquina
        ...
        private void cmdIngresar_Click(object sender, System.EventArgs e)
        {
            ...
            {
                string mensajeError = Mensajes.Obtener(Mensajes.ERROR_INGRESANDO, Mensajes.ASSEMBLY);
        ...
        /// <summary>
        /// Mtodo que valida si los datos de una pantalla determinada 
        /// son vlidos o no.
        /// </summary>
        /// <returns>True si los datos son vlidos</returns>
