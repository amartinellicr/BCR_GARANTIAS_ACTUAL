...
function CalcularMontoMitigador() {
    ...
    var indicadorHPAA = ($$('btnValidarOperacion').attr("HPAA"));
    var montoTasActTerreno = (($$('txtMontoTasActTerreno').val().length > 0) ? $$('txtMontoTasActTerreno').val() : '0');
    var montoTasActNoTerreno = (($$('txtMontoTasActNoTerreno').val().length > 0) ? $$('txtMontoTasActNoTerreno').val() : '0');
    ...
    if (($$('btnValidarOperacion').attr("HPAA")) === '0') {
        ...
        $.ajax({
            ...
            data: '{"porcentajeAceptacion":"' + datoPorcentajeAcep + '", "porcentajeAceptacionCalc":"' + datoPorcentajeAcepCalc + '", "montoTasActTerreno":"' + montoTasActTerreno + '", "montoTasActNoTerreno":"' + montoTasActNoTerreno + '"}',
