    ...
    public partial class frmDeudores : BCR.Web.SystemFramework.PaginaPersistente
    {
        ...
        private void CargarDatos()
        {
            try
            {
                ...
                CargarComboTipos();
                cbTipo.Items.FindByValue(((cbTipo.Items.FindByValue(dsDatos.Tables["Deudor"].Rows[0][2].ToString()) != null) ? dsDatos.Tables["Deudor"].Rows[0][2].ToString() : "-1")).Selected = true;
                txtNombre.Text = dsDatos.Tables["Deudor"].Rows[0][1].ToString();
                CargarComboCondiciones();
                cbCondicion.Items.FindByValue(((cbCondicion.Items.FindByValue(dsDatos.Tables["Deudor"].Rows[0][3].ToString()) != null) ? dsDatos.Tables["Deudor"].Rows[0][3].ToString() : "-1")).Selected = true;
                CargarTiposAsignacion();
                cbTipoAsignacion.Items.FindByValue(((cbTipoAsignacion.Items.FindByValue(dsDatos.Tables["Deudor"].Rows[0][4].ToString()) != null) ? dsDatos.Tables["Deudor"].Rows[0][4].ToString() : "-1")).Selected = true;
                CargarGenerador();
                cbGenerador.Items.FindByValue(((cbGenerador.Items.FindByValue(dsDatos.Tables["Deudor"].Rows[0][5].ToString()) != null) ? dsDatos.Tables["Deudor"].Rows[0][5].ToString() : "-1")).Selected = true;
                CargarVinculado();
                cbVinculadoEntidad.Items.FindByValue(((cbVinculadoEntidad.Items.FindByValue(dsDatos.Tables["Deudor"].Rows[0][6].ToString()) != null) ? dsDatos.Tables["Deudor"].Rows[0][6].ToString() : "-1")).Selected = true;
            }
            catch (Exception ex)
            {
                lblMensaje.Text = ex.Message;
