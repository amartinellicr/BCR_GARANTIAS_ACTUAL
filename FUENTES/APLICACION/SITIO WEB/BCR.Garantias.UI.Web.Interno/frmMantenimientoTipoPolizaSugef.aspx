<%@ Page Language="C#" MasterPageFile="~/Pagina Maestra/mtpMenuPrincipal.master" AutoEventWireup="true" CodeFile="frmMantenimientoTipoPolizaSugef.aspx.cs" Inherits="BCRGARANTIAS.Forms.frmMantenimientoTipoPolizaSugef" Title="BCR GARANTIAS - Catálogos" %>
								...
								<td>
									<table width="100%" align="center" border="0">
										...
										<tr>
											...
											<td><asp:textbox id="txtDescripcion" tabIndex="2" runat="server" CssClass="Txt_Style_Default" Width="299px"
													BackColor="AliceBlue" MaxLength="150"></asp:textbox></td>
										</tr>
										<tr>
											<td class="td_Texto" style="WIDTH: 286px">Detalle:</td>
											<td><asp:textbox id="txtDetalle" tabIndex="2" runat="server" CssClass="Txt_Style_Default" Width="299px" Height="100px"
													BackColor="AliceBlue" MaxLength="500" TextMode="MultiLine"></asp:textbox></td>
										</tr>
										<tr>
								...
								<td align="center">
								    <br/>
								        <asp:GridView ID="gdvCatalogos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="730px" AllowPaging="True" AllowSorting="True"
                                         AutoGenerateColumns="False" DataKeyNames="TipoPolizaSugef,NombreTipoPolizaSugef,DescripcionTipoPolizaSugef" 
                                         ...
                                         OnPageIndexChanging="gdvCatalogos_PageIndexChanging" CssClass="gridview" BorderColor="black">
                                            ...
                                            <Columns>
                                                <asp:ButtonField DataTextField="TipoPolizaSugef" CommandName="SelectedCatalogo" HeaderText="Código" Visible="True" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderColor="black" HeaderStyle-BorderColor="black"/>
                                                <asp:ButtonField DataTextField="NombreTipoPolizaSugef" CommandName="SelectedCatalogo" HeaderText="Descripción" Visible="True" ItemStyle-Width="230px" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderColor="black" HeaderStyle-BorderColor="black"/>
                                                <asp:ButtonField DataTextField="DescripcionTipoPolizaSugef" CommandName="SelectedCatalogo" HeaderText="Detalle" Visible="True" ItemStyle-Width="630px" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderColor="black" HeaderStyle-BorderColor="black"/>
                                            </Columns>
