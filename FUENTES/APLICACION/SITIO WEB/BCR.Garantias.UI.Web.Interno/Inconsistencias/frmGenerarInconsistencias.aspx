							...
							<td>
								<table width="100%" align="center" border="0">
									...
									<tr>
										<td class="td_Texto"></td>
										<td class="td_TextoIzq"> 
										    <asp:checkbox id="chkPolizasGarantiasReales" runat="server" Text="Errores en Pólizas"></asp:checkbox>
										</td>
									</tr>
                                    <tr>
										<td class="td_Texto"></td>
										<td class="td_TextoIzq"> 
										    <asp:checkbox id="chkErrorPorcentajeAceptacion" runat="server" Text="Errores en Porcentaje de Aceptación"></asp:checkbox>
										</td>
									</tr>
<%--									<tr>
										<td class="td_Texto"></td>
