...
{
    public class ContenedorAvance_x_oficina_cliente : ContenedorBase
    {
        #region Constantes
        public const string NOMBRE_ENTIDAD = "RPT_AVANCE_X_OFICINA_CLIENTE";
        ...
        public ContenedorAvance_x_oficina_cliente()
		{
