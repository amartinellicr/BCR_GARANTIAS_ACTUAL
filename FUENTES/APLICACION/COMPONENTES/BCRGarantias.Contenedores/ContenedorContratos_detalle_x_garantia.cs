...
{
    public class ContenedorContratos_detalle_x_garantia : ContenedorBase
    {
        #region Constantes
        public const string NOMBRE_ENTIDAD = "RPT_CONTRATOS_DETALLE_X_GARANTIA";
        ...
        public ContenedorContratos_detalle_x_garantia()
		{
