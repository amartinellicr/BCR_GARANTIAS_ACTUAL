...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			DELETE	FROM dbo.AUX_GARANTIAS_REALES_OPERACIONES 
		...
		BEGIN	
			...
			CREATE TABLE dbo.AUX_GAR_HIPOTECAS_SICC (	prmgt_pcoclagar TINYINT,
												prmgt_pnu_part  TINYINT,
												prmgt_pnuidegar DECIMAL(12,0))
		 
			CREATE INDEX TEMP_GAR_HIPOTECAS_IX_01 ON dbo.AUX_GAR_HIPOTECAS_SICC (prmgt_pcoclagar, prmgt_pnu_part, prmgt_pnuidegar)


			/*Esta tabla almacenará las garantías hipotecarias alfanuméricas del SICC que estén activas*/
			CREATE TABLE dbo.AUX_GAR_HIPOTECAS_SICC_ALF (	prmgt_pcoclagar TINYINT,
													prmgt_pnu_part  TINYINT,
													prmgt_pnuidegar DECIMAL(12,0),
													prmgt_pnuide_alf CHAR(12))
		 
			CREATE INDEX TEMP_GAR_HIPOTECAS_ALF_IX_01 ON dbo.AUX_GAR_HIPOTECAS_SICC_ALF (prmgt_pcoclagar, prmgt_pnu_part, prmgt_pnuidegar, prmgt_pnuide_alf)


			/*Esta tabla almacenará las garantías prendarias no alfanuméricas del SICC que estén activas*/
			CREATE TABLE dbo.AUX_GAR_PRENDAS_SICC (	prmgt_pcoclagar TINYINT,
												prmgt_pnuidegar DECIMAL(12,0))
		 
			CREATE INDEX TEMP_GAR_PRENDAS_IX_01 ON dbo.AUX_GAR_PRENDAS_SICC (prmgt_pcoclagar, prmgt_pnuidegar)


			/*Esta tabla almacenará las garantías prendarias alfanuméricas del SICC que estén activas*/
			CREATE TABLE dbo.AUX_GAR_PRENDAS_SICC_ALF (	prmgt_pcoclagar TINYINT,
													prmgt_pnuidegar DECIMAL(12,0),
													prmgt_pnuide_alf CHAR(12))
		 
			CREATE INDEX TEMP_GAR_PRENDAS_ALF_IX_01 ON dbo.AUX_GAR_PRENDAS_SICC_ALF (prmgt_pcoclagar, prmgt_pnuidegar, prmgt_pnuide_alf)



			/*Esta tabla almacenará las garantías registradas en el sistema, según el tipo de garantía real*/
			CREATE TABLE dbo.AUX_GARANTIA_REAL_CMTA (	cod_garantia_real BIGINT)
			...
			CREATE TABLE dbo.AUX_OPERACIONES_SICC (prmoc_pco_ofici	SMALLINT,
			...
			CREATE INDEX AUX_OPERACIONES_SICC_IX_01 ON dbo.AUX_OPERACIONES_SICC (prmoc_pco_ofici, prmoc_pco_moned, prmoc_pco_produ, prmoc_pnu_oper)
			...
			CREATE TABLE dbo.AUX_CONTRATOS_VIGENTES_SICC (	prmca_pco_ofici		SMALLINT,
			...
			INSERT	INTO dbo.AUX_CONTRATOS_VIGENTES_SICC (prmca_pco_ofici, prmca_pco_moned, prmca_pco_produc, prmca_pnu_contr, producto_prmgt)
			...
			CREATE INDEX AUX_CONTRATOS_VIGENTES_SICC_IX_01 ON dbo.AUX_CONTRATOS_VIGENTES_SICC (prmca_pco_ofici, prmca_pco_moned, prmca_pco_produc, prmca_pnu_contr)
			...
			CREATE TABLE dbo.AUX_GIROS_ACTIVOS_SICC (	prmca_pco_ofici		SMALLINT,
											prmca_pco_moned		TINYINT,
											prmca_pco_produc	TINYINT,
											prmca_pnu_contr		INT,
											producto_prmgt		TINYINT)
			...
			INSERT	INTO dbo.AUX_GIROS_ACTIVOS_SICC (prmca_pco_ofici, prmca_pco_moned, prmca_pco_produc, prmca_pnu_contr, producto_prmgt)
			...
			CREATE INDEX AUX_GIROS_ACTIVOS_SICC_IX_01 ON dbo.AUX_GIROS_ACTIVOS_SICC (prmca_pco_ofici, prmca_pco_moned, prmca_pco_produc, prmca_pnu_contr)
			...
			/*TABLA AUXILIAR DE GARANTIAS QUE PARTICIPARAN EN EL CALCULO DE  LOS MONTOS DE LAS TASACIONES ACTUALIZADAS*/
			IF OBJECT_ID('dbo.AUX_GARANTIA_REAL_CMTA') IS NOT NULL
				DROP TABLE dbo.AUX_GARANTIA_REAL_CMTA


			/*Esta tabla almacenará las garantías registradas en el sistema, según el tipo de garantía real*/
			CREATE TABLE dbo.AUX_GARANTIA_REAL_CMTA 
			(	
			...
			INSERT	INTO dbo.AUX_GARANTIA_REAL_CMTA(cod_garantia_real, Fecha_Valuacion)
			...
			/*Se carga la información de las garantías reales de tipo hipoteca común alfanumericas y que están relacionadas a una operación o contrato*/
			INSERT	INTO dbo.AUX_GARANTIA_REAL_CMTA(cod_garantia_real, Fecha_Valuacion)
			SELECT	GGR.cod_garantia_real,
					TMP.Fecha_Valuacion
			FROM	dbo.GAR_GARANTIA_REAL GGR
			...
			/*Se carga la información de las garantías reales de tipo prenda no alfanumericas y que están relacionadas a una operación o contrato*/
			INSERT	INTO dbo.AUX_GARANTIA_REAL_CMTA(cod_garantia_real, Fecha_Valuacion)
			SELECT	GGR.cod_garantia_real,
					TMP.Fecha_Valuacion
			FROM	dbo.GAR_GARANTIA_REAL GGR
			...
			/*Se carga la información de las garantías reales de tipo prenda alfanumericas y que están relacionadas a una operación o contrato*/
			...
			CREATE INDEX AUX_GARANTIA_REAL_CMTA_IX_01 ON dbo.AUX_GARANTIA_REAL_CMTA (cod_garantia_real) ON [PRIMARY]
			 ...
			 *                                                                                              *
			 ************************************************************************************************/
			 /*TABLA AUXILIAR DE GARANTIAS RELACIONADAS QUE PARTICIPARAN EN EL CALCULO DE  LOS MONTOS DE LAS TASACIONES ACTUALIZADAS*/
			IF OBJECT_ID('dbo.AUX_GARANTIAS_REALES_OPERACIONES') IS NOT NULL
				DROP TABLE dbo.AUX_GARANTIAS_REALES_OPERACIONES

			 CREATE TABLE dbo.AUX_GARANTIAS_REALES_OPERACIONES
			 (
				Codigo_Llave BIGINT IDENTITY(1,1) NOT NULL,
				...
				Operacion DECIMAL(7, 0) NOT NULL,
				Codigo_Tipo_Bien SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Tipo_Bien  DEFAULT ((-1)),
				Codigo_Tipo_Mitigador SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Tipo_Mitigador  DEFAULT ((-1)),
				Codigo_Tipo_Documento_Legal SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Tipo_Documento_Legal  DEFAULT ((-1)),
				Codigo_Inscripcion SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Inscripcion  DEFAULT ((-1)),
				Codigo_Tipo_Garantia_Real TINYINT NOT NULL,
				Codigo_Estado SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Estado  DEFAULT (1),
				Codigo_Grado_Gravamen SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Grado_Gravamen  DEFAULT ((-1)),
				Codigo_Clase_Garantia SMALLINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Clase_Garantia  DEFAULT ((-1)),
				Codigo_Partido TINYINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Partido  DEFAULT (0),
				Codigo_Tipo_Garantia TINYINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Tipo_Garantia  DEFAULT (2),
				Codigo_Tipo_Operacion TINYINT NOT NULL,
				Indicador_Duplicidad TINYINT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Indicador_Duplicidad  DEFAULT (1),
				Porcentaje_Responsabilidad DECIMAL(5, 2) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Porcentaje_Responsabilidad  DEFAULT (0),
				Monto_Mitigador DECIMAL(18, 2) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Monto_Mitigador  DEFAULT (0),
				Codigo_Grado CHAR(2) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Grado  DEFAULT (''),
				Codigo_Clase_Bien CHAR(3) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Clase_Bien  DEFAULT (''),
				Cedula_Hipotecaria CHAR(2) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Cedula_Hipotecaria  DEFAULT (''),
				Codigo_Bien VARCHAR(25) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Codigo_Bien  DEFAULT ('-'),
				Fecha_Presentacion VARCHAR(10) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Fecha_Presentacion  DEFAULT ('1900-01-01'),
				Fecha_Constitucion VARCHAR(10) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Fecha_Constitucion  DEFAULT ('1900-01-01'),
				Numero_Finca VARCHAR(25) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Numero_Finca  DEFAULT (''),
				Numero_Placa_Bien VARCHAR(25) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_Numero_Placa_Bien  DEFAULT (''),
				Codigo_Usuario VARCHAR(30) NOT NULL,
				Indicador_Calcular_MTAT_MTANT BIT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_IndicadorCalcularMTATMTANT  DEFAULT ((0)),
				Indicador_Calcular_PATC BIT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_IndicadorCalcularPATC  DEFAULT ((0)),
				Indicador_Calcular_PANTC BIT NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_IndicadorCalcularPANTC  DEFAULT ((0)),
				Porcentaje_Aceptacion DECIMAL(5, 2) NOT NULL CONSTRAINT DF_AUX_GARANTIAS_REALES_OPERACIONES_PorcentajeAceptacion  DEFAULT ((-1)),
				 CONSTRAINT AUX_GARANTIAS_REALES_OPERACIONES_PK PRIMARY KEY CLUSTERED 
				(
					Codigo_Llave ASC
				)
			) ON [PRIMARY]
			...
			INSERT INTO dbo.AUX_GARANTIAS_REALES_OPERACIONES (Codigo_Operacion, Codigo_Garantia_Real, Codigo_Contabilidad, 
			...
			FROM	dbo.AUX_GARANTIA_REAL_CMTA TGR
				...
				INNER JOIN dbo.AUX_OPERACIONES_SICC TMP
			...
			FROM	dbo.AUX_GARANTIA_REAL_CMTA TGR
				...
				INNER JOIN dbo.GAR_OPERACION GO1
				ON GO1.cod_operacion = GRO.cod_operacion
				INNER JOIN dbo.AUX_CONTRATOS_VIGENTES_SICC TMP
			...
			FROM	dbo.AUX_GARANTIA_REAL_CMTA TGR
				...
				INNER JOIN dbo.GAR_OPERACION GO1
				ON GO1.cod_operacion = GRO.cod_operacion
				INNER JOIN dbo.AUX_GIROS_ACTIVOS_SICC TMP
				ON TMP.prmca_pco_ofici = GO1.cod_oficina
				AND TMP.prmca_pco_moned = GO1.cod_moneda
				AND TMP.prmca_pco_produc = GO1.cod_producto
				AND TMP.prmca_pnu_contr = GO1.num_contrato 
			...
			CREATE INDEX AUX_GARANTIAS_REALES_OPERACIONES_IX_01 ON dbo.AUX_GARANTIAS_REALES_OPERACIONES (Codigo_Usuario, Codigo_Tipo_Garantia_Real, Codigo_Tipo_Bien, Codigo_Tipo_Mitigador) ON [PRIMARY]

			

			/*Se determinan los registros a los que se les calculará el porcentaje de aceptación del terreno calculado*/
		
			/*Regla aplicada: 
				Tipo Garantía Real: 1 (Hipoteca Común), 
				Tipo de Bien: 1 (Terrenos), 
				Tipo de Mitigador de Riesgo: 1 (Hipotecas sobre terrenos).*/
			UPDATE	dbo.AUX_GARANTIAS_REALES_OPERACIONES
			...
			*/
			...
			DELETE	dbo.AUX_GARANTIAS_REALES_OPERACIONES 
			WHERE	Codigo_Usuario = @psCedula_Usuario
		...
		BEGIN
			 ...
			 *                                                                                              *
			 ************************************************************************************************/
			/*TABLA AUXILIAR DE GARANTIAS REALES POR OPERACION*/
			IF OBJECT_ID('dbo.AUX_GARANTIAS_REALES_X_OPERACION') IS NOT NULL
				DROP TABLE dbo.AUX_GARANTIAS_REALES_X_OPERACION


			CREATE TABLE dbo.AUX_GARANTIAS_REALES_X_OPERACION (	Cod_Llave							BIGINT		IDENTITY(1,1),
			...
			INSERT INTO dbo.AUX_GARANTIAS_REALES_X_OPERACION 
			...
			SELECT	DISTINCT 
					...
					CASE WHEN GRV.Tipo_Moneda_Tasacion = 2 THEN GRV.Monto_Total_Avaluo_Colonizado
						 ELSE GRV.monto_total_avaluo
				    END AS Monto_Avaluo_SICC,
					NULL,
					TGR.Codigo_Tipo_Bien,
					TGR.Codigo_Usuario
			FROM	dbo.AUX_GARANTIAS_REALES_OPERACIONES TGR 
				INNER JOIN dbo.GAR_GARANTIAS_REALES_X_OPERACION GRO 
			...
			CREATE INDEX AUX_GARANTIAS_REALES_X_OPERACION_IX_01 ON dbo.AUX_GARANTIAS_REALES_X_OPERACION (Cod_Usuario, Cod_Operacion, Cod_Garantia_Real)


			--Se actualiza la fecha de la penúltima valuación
			UPDATE	dbo.AUX_GARANTIAS_REALES_X_OPERACION
			SET		Penultima_Fecha_Valuacion = COALESCE(GRV.fecha_valuacion,'19000101')
			FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION TGR
				INNER JOIN dbo.GAR_VALUACIONES_REALES GRV 
			...
			BEGIN
				...
				BEGIN TRANSACTION TRA_Ajustar_Monto2
					...
					FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION TGR
						...
						AND GVR.fecha_valuacion = TGR.Fecha_Valuacion
					WHERE	TGR.Cod_Usuario = @psCedula_Usuario 
						AND COALESCE(TGR.Monto_Ultima_Tasacion_Terreno, 0) = 0
				...
				DELETE FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION
				...
				FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION
		...
		BEGIN
			 ...
			 ************************************************************************************************/
			/*TABLA AUXILIAR DE GARANTIAS REALES POR OPERACION*/
			IF OBJECT_ID('dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC') IS NOT NULL
				DROP TABLE dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC

			CREATE TABLE dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC (Cod_Llave						BIGINT		IDENTITY(1,1),
															Cod_Contabilidad						TINYINT,
															Cod_Oficina								SMALLINT,
															Cod_Moneda								TINYINT,
															Cod_Producto							TINYINT,
			...
			--Se ingresan los datos de las garantías filtradas
			INSERT INTO dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC 
			(Cod_Contabilidad, Cod_Oficina, Cod_Moneda, Cod_Producto, Operacion, Cod_Operacion, 
			 Cod_Garantia_Real, Cod_Tipo_Garantia_real, Cod_Tipo_Operacion, Cod_Bien, Codigo_Partido, Numero_Finca, 
			...
			CREATE INDEX AUX_GARANTIAS_REALES_X_OPERACION_PAC_IX_01 ON dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC (Cod_Usuario, Cod_Operacion, Cod_Garantia_Real)
			...
			FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC TMP
			...
			UPDATE	dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC 
			...
			FROM	dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC TGR
			...
			FROM	dbo.TMP_CALCULO_MTAT_MTANT TCM
				INNER JOIN dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC TMP
			...
			DELETE FROM dbo.AUX_GARANTIAS_REALES_X_OPERACION_PAC
