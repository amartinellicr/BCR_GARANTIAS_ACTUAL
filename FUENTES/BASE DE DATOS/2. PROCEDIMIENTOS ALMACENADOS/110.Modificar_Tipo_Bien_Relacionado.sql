...
/*****************************************************************************************************************************************************
	...
	<Descripción>
		Procedimiento almacenado que se encarga de modificar la información de la relación existente entre tipos de bien, tipos de pólizas SUGEF y
		tipo de pólizas SAP. 
	</Descripción>
	<Entradas>
		...
		@piCatalogo_Tipo_Poliza			= Código del catálogo de los tipos de póliza SAP (29).
		@piCatalogo_Tipo_Bien			= Código del catálogo de los tipos de bien (12).
	</Entradas>
	<Salidas>
	...
	<Historial>
		<Cambio>
			...
			<Descripción> Se modifica el primer if exists </Descripción>
		</Cambio>
	</Historial>
*****************************************************************************************************************************************************/
	...
	BEGIN
			SET @psRespuesta = N'<RESPUESTA><CODIGO>1</CODIGO><NIVEL></NIVEL><ESTADO></ESTADO><PROCEDIMIENTO>Modificar_Tipo_Bien_Relacionado</PROCEDIMIENTO><LINEA>' + CONVERT(VARCHAR(100), @viConsecutivo_Relacion) + '</LINEA>' + 
								'<MENSAJE>El registro ya existe.</MENSAJE><DETALLE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El registro ya existe.</DETALLE></RESPUESTA>'
	...
	BEGIN
		SET @psRespuesta = N'<RESPUESTA><CODIGO>2</CODIGO><NIVEL></NIVEL><ESTADO></ESTADO><PROCEDIMIENTO>Modificar_Tipo_Bien_Relacionado</PROCEDIMIENTO><LINEA></LINEA>' + 
							'<MENSAJE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de bien no existe.</MENSAJE><DETALLE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de bien no existe.</DETALLE></RESPUESTA>'
	...
	BEGIN
		SET @psRespuesta = N'<RESPUESTA><CODIGO>3</CODIGO><NIVEL></NIVEL><ESTADO></ESTADO><PROCEDIMIENTO>Modificar_Tipo_Bien_Relacionado</PROCEDIMIENTO><LINEA></LINEA>' + 
							'<MENSAJE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de póliza SAP no existe.</MENSAJE><DETALLE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de póliza SAP no existe.</DETALLE></RESPUESTA>'
	...
	BEGIN
		SET @psRespuesta = N'<RESPUESTA><CODIGO>4</CODIGO><NIVEL></NIVEL><ESTADO></ESTADO><PROCEDIMIENTO>Modificar_Tipo_Bien_Relacionado</PROCEDIMIENTO><LINEA></LINEA>' + 
							'<MENSAJE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de póliza SUGEF no existe.</MENSAJE><DETALLE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El tipo de póliza SUGEF no existe.</DETALLE></RESPUESTA>'
		...
		BEGIN TRANSACTION TRA_Act_Rel_Tipol_Tipobien --Inicio
			...
			BEGIN CATCH
				...
				SET @psRespuesta = N'<RESPUESTA><CODIGO>5</CODIGO><NIVEL></NIVEL><ESTADO></ESTADO><PROCEDIMIENTO>Modificar_Tipo_Bien_Relacionado</PROCEDIMIENTO><LINEA></LINEA>' + 
									'<MENSAJE>Problema al modificar el registro.</MENSAJE><DETALLE>Se produjo un error al modificar los datos de la relación entre los tipos de póliza y el tipo de bien. El código obtenido es: ' + CONVERT(VARCHAR(1000), @@ERROR) + '</DETALLE></RESPUESTA>'
