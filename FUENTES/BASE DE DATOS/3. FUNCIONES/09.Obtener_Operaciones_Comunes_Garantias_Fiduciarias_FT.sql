...
IF OBJECT_ID('Obtener_Operaciones_Comunes_Garantias_Fiduciarias_FT') IS NOT NULL 
    DROP FUNCTION Obtener_Operaciones_Comunes_Garantias_Fiduciarias_FT;
GO


CREATE FUNCTION [dbo].[Obtener_Operaciones_Comunes_Garantias_Fiduciarias_FT] 
(
...
/*****************************************************************************************************************************************************
	<Nombre>Obtener_Operaciones_Comunes_Garantias_Fiduciarias_FT</Nombre>
	<Sistema>BCRGarantías</Sistema>
	<Descripción>
		Función que se encarga de obtener las operaciones, contratos y giros de contrato de una mismas garantía fiduciaria, así mismo los consecutivos de las
		garantías que sean del mismo fiador.
	</Descripción>
	<Entradas>		
...
BEGIN
	...
	FROM	dbo.GAR_GARANTIA_FIDUCIARIA GGF WITH(NOLOCK) 
		INNER JOIN dbo.GAR_GARANTIAS_FIDUCIARIAS_X_OPERACION GFO WITH(NOLOCK)
	...
	WHERE	GGF.Identificacion_Sicc = @viIdentificacion_Garantia
